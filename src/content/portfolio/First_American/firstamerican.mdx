...
export const query = graphql`
  query {
    ...
    fa5: file(relativePath: { eq: "First_American/fa-05.png" }) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid
        }
...
<ImageContainer classes="large" fluid={props.data.fa5.childImageSharp.fluid} />
...
<ImageContainer classes="large" fluid={props.data.fa7.childImageSharp.fluid} />
